...
#if defined(__GNUC__)
#define BOOTSTRAP_INSTALL_SIZE_OPT __attribute__((optimize("Os")))
#else
#define BOOTSTRAP_INSTALL_SIZE_OPT
#endif

void BOOTSTRAP_INSTALL_SIZE_OPT bootstrap_controller_install(
    unsigned char header[APA_HEADER_SIZE],
    boot_chain_info_t *boot_chain);

#undef BOOTSTRAP_INSTALL_SIZE_OPT
