...
static const video_mode_identity_t identities[VIDEO_MODE_COUNT] = {
    {"native", "Native automatic (640x224 field)",
     {640, 448, 640, 224, 640, 224, 0, 0, 640, 224, 32, 1, 1}},
    {"480p", "480p progressive (720x448)",
     {720, 480, 720, 448, 768, 448, 0, 0, 720, 448, 32, 0, 1}},
    {"576p", "576p progressive (720x576)",
     {720, 576, 720, 576, 768, 576, 40, 64, 640, 448, 16, 0, 0}},
    {"720p", "720p progressive (1280x720)",
     {1280, 720, 640, 720, 640, 720, 0, 136, 640, 448, 16, 0, 0}},
    {"1080i", "1080i interlaced (1920x1080)",
     {1920, 1080, 640, 1080, 640, 1080, 0, 92, 640, 896, 16, 1, 0}}
};
